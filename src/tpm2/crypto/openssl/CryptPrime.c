...
static void
RsaAdjustPrimeCandidate_PreRev165(
			    Crypt_Int* prime
			   )
{
...
// issues.
//
static void RsaAdjustPrimeCandidate_PostRev165(BYTE* bigNumberBuffer, size_t bufSize)	// libtpms: renamed
{
...
static TPM_RC TpmRsa_GeneratePrimeForRSA_PostRev165(		// libtpms: renamed
				  ...
				  )
{
    ...
    while(OK && !found)
	{
	    ...
	    large.t.size = bytes;
	    RsaAdjustPrimeCandidate_PostRev165(large.t.buffer, bytes);	// libtpms renamed
				  ...
				  )
{
	...
	break;
    case SEED_COMPAT_LEVEL_LAST: /* introduced before rev 181, after rev 164 */
	return TpmRsa_GeneratePrimeForRSA_PostRev165(prime, bits, exponent, rand);
    }
