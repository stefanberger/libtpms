...
/*            $Id: Global.h 1476 2019-06-10 19:32:03Z kgoldman $		*/
/*										*/
...
typedef struct OBJECT
{
    ...
    // libtpms added: COMPAT_LEVEL to use for deriving child keys
...
typedef struct
{
    ...
    TPM2B_SEED          SPSeed;
    TPM2B_SEED          PPSeed;
    // COMPAT_LEVELs related to creation time of seeds
    COMPAT_LEVEL        EPSeedCompatLevel; // libtpms added begin
    COMPAT_LEVEL        SPSeedCompatLevel;
    COMPAT_LEVEL        PPSeedCompatLevel; // libtpms added end
...
typedef struct state_reset_data
{
    ...
    COMPAT_LEVEL        nullSeedCompatLevel; // libtpms added
