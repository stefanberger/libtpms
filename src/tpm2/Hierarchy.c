...
/*            $Id: Hierarchy.c 1476 2019-06-10 19:32:03Z kgoldman $		*/
/*										*/
			 ...
			 )
{
    ...
    gp.EPSeedCompatLevel = COMPAT_LEVEL_LAST;   // libtpms added begin
    gp.SPSeedCompatLevel = COMPAT_LEVEL_LAST;
    gp.PPSeedCompatLevel = COMPAT_LEVEL_LAST;   // libtpms added end
